...
export class MobileNumberComponent implements OnInit {
  ...
  displayedColumns = [
    ...
    { key: "oldMobileNumber", value: `auditReports.oldNumber` },
    { key: "newMobileNumber", value: `auditReports.newNumber` },
    ...
    this.mobileNumberForm
      ...
      .subscribe((domain) => {
        if (this.mobileNumberForm.controls.aliasId.value) {
          this.mobileNumberForm.controls.aliasId.setValue([
            "",
            Validators.required,
          ]);
        }
        ...
        this.mobileNumberForm.controls.oldMobileNo.setValidators([
          Validators.pattern(this.domainConfig.UI_MOBILE_REGEX),
        ]);
        this.mobileNumberForm.controls.oldMobileNo.updateValueAndValidity();
        this.mobileNumberForm.controls.newMobileNo.setValidators([
          Validators.pattern(this.domainConfig.UI_MOBILE_REGEX),
        ]);
        this.mobileNumberForm.controls.newMobileNo.updateValueAndValidity();
        this.mobileNumberForm.controls.rsaId.setValidators([
          Validators.pattern(this.domainConfig.PRIMARY_ID_REGEX),
        ]);
        this.mobileNumberForm.controls.rsaId.updateValueAndValidity();
        if (domain.domainId) this.getAliasLiast();
      });
    ...
    this.mobileNumberForm
      ...
      .subscribe((date) => {
        ...
        let endDate = this.utilService.formatDate(
          this.mobileNumberForm.get("endDate").value
        );
  ...
  onSearch(type?) {
    if (this.mobileNumberForm.valid) {
      let request = {
        ...
        mobileChangeData: {
          ...
          startDate: this.utilService.formatDate(
            this.mobileNumberForm.get("startDate").value
          ),
      ...
      this.commonHelper
        .makeRequest(request, "fetchMobileNumberChangeReport", true)
        .pipe(takeUntil(this.destroy$))
        .subscribe((res) => {
