...
export class UserUpdateReportComponent implements OnInit {
  ...
  displayedColumns = [
    { key: "firstName", value: `userUpdateReport.firstName` },
    { key: "lastName", value: `userUpdateReport.lastName` },
    { key: "dateOfChange", value: `userUpdateReport.dateOfChange` },
    { key: "timeOfChange", value: `userUpdateReport.timeOfChange` },
    { key: "changedType", value: `userUpdateReport.changedType` },
    { key: "oldValue", value: `userUpdateReport.oldValue` },
    { key: "newValue", value: `userUpdateReport.newValue` },
    { key: "changedBy", value: `userUpdateReport.changedBy` },
  ];
  constructor(
    ...
    this.userUpdateForm
      ...
      .subscribe((date) => {
        ...
        let endDate = this.utilService.formatDate(
          this.userUpdateForm.get("endDate").value
        );
  ...
  onSearch() {
    if (this.userUpdateForm.valid) {
      let request = {
        ...
        userDataChangeReportRequest: {
          ...
          startDate: this.utilService.formatDate(
            this.userUpdateForm.get("startDate").value
          ),
      ...
      this.commonHelper
        .makeRequest(request, "canFetchUserUpdateReport", true)
        .pipe(takeUntil(this.destroy$))
        .subscribe((res) => {
          if (res.statusCode == 0) {
